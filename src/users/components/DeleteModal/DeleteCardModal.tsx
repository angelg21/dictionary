...
const DeleteModal: React.FC<DeleteModalProps> = ({ onClose, onDelete }) => {
  ...
  const handleDelete = async () => {
    ...
    if (success) {
      showAlert("Ficha eliminada con éxito!!!", "success");
    } else {
      showAlert("Error al eliminar la ficha", "error");
    }
    onClose();
  };
      ...
      <div className="bg-white p-6 rounded-md max-w-xl w-full">
        <div className="flex items-center mb-4 justify-between">
            <div className='flex flex-row items-center'>
                ...
                <h2 className="text-xl font-semibold text-gray-800 ml-2">Eliminar Ficha</h2>
            </div>
        ...
        <p className="text-gray-600 mb-4">
            ¿Estás seguro de que deseas eliminar esta ficha? Esta será eliminada permanentemente de nuestros servidores para siempre. Esta acción no se puede deshacer.
        </p>
