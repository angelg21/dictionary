    ...
    return (
        <div className="lg:pl-[73vw] xl:pl-[76vw] 2xl:pl-[80vw] ">
            <div className="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 bg-d-fondo px-4 shadow-sm sm:gap-x-6 sm:px-6 ">
                ...
                <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6 flex-shrink-0">
                        ...
                        <Menu as="div" className="relative">
                            <MenuButton className="-m-1.5 flex items-center p-1.5">
                                ...
                                <span className=" hidden lg:flex lg:items-center">
                                    <span aria-hidden="true" className="ml-4 text-sm font-semibold leading-6 text-gray-900 flex-shrink-0">
                                        Tom Cook
                                    </span>
