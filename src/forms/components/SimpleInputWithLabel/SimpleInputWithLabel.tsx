...
export const SimpleInputWithLabel = ({id, name, type, placeholder, label, labelTextStyle, inputWidth, focusBorderColor, globalStyle, value, onChange}: SimpleInputProps) => {
