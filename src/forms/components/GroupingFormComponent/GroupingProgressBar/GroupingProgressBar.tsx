...
const steps =
    [
        { id: '01', name: 'Detalles de la Agrupación', href: '/dashboard/forms/groupingForm/groupingDetails' },
        { id: '02', name: 'Críticas', href: '/dashboard/forms/groupingForm/groupingCriticism' },
        { id: '03', name: 'Revisión', href: '/dashboard/forms/groupingForm/groupingFormReview' },
    ]
