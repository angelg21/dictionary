...
export const SidebarMenuItems = ({ path, icon: Icon, title, onClick }: Props) => {
    ...
    const iconClasses = `
        ${ pathName === path || ((pathName === '/dashboard/worksheets/allSheets' || pathName === '/dashboard/worksheets/sheetsToComplete' || pathName === '/dashboard/worksheets/sheetsToReview' || pathName === '/dashboard/worksheets/validatedSheets') && title === 'Fichas')
