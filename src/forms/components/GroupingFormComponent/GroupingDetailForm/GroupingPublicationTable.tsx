...
interface PublicationsTableProps {
    publications: { title: string, year: number | '', authors: string, summary: string }[];
    onDelete: (index: number) => void;
    onEdit: (index: number) => void;
}


export const GroupingPublicationTable = ({publications, onDelete, onEdit}: PublicationsTableProps) => {
    return (
                        ...
                        <tbody className="divide-y divide-gray-200 bg-white">
                            {publications.map((publication, index) => (
                                ...
                                <tr key={index}>
                                    ...
                                    <td className="whitespace-nowrap py-4 pl-4 pr-3 text-sm">
                                        <div className="font-medium text-gray-900">{publication.year}</div>
                                    </td>
