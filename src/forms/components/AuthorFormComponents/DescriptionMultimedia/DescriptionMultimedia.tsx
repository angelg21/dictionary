...
interface DescriptionMultimedia {
    id: string,
...
export const DescriptionMultimedia = ({id, placeholder, label, labelTextStyle, globalStyle, value, onChange, multimediaLink}: DescriptionMultimedia) => {
    return (
